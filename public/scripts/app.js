...
define([
    ...
    predixApp.controller('MainCtrl', ['$scope', '$rootScope', 'PredixUserService', function ($scope, $rootScope, predixUserService) {
        ...
        window.App = $rootScope.App = {
            ...
            session: {},
            tabs: [
                {icon: 'fa-tachometer', state: 'finsum-dashboard', label: 'FinSum'},
				{icon: '', state: 'Search-load', label: 'Search & Load'},
				{icon: '', state: 'my-favorites', label: 'My Favorites'},
				{icon: 'fa-user', state: 'administration-dashboard', label: 'Adminstration'},
				{icon: '', state: 'manage-fx', label: 'Manage Fx'},
				{icon: '', state: 'manage-tiers', label: 'Manage Tiers'},
				{icon: '', state: 'access-control', label: 'Access Control'}
            ]
        };
